...
<div class="container">
    ...
    <div class="news">
        ...
        <div class="books">
            <div class="col-sm-3">
                <img src="http://placehold.it/191x300" class="img-thumbnail" alt="Cinque Terre">
            </div>
            <div class="col-sm-9">
                <div class="lat_news"><a href="#" class="book-title"><h3>Название...</h3></a></div>
            </div>
            <div class="col-sm-9">
                <div class="about"><i>Информация о дате и авторе...</i></div>
            </div>
            <div class="col-sm-9">
                <div class="description">Описание книги...</div>
            </div>
        </div>
